...
public class ResponseMessageUser {
    ...
    public static final String SUCCESS_UPDATE_USER = "Success update user";
    public static final String SUCCESS_GET_USER = "Success fetch user";
    public static final String SUCCESS_GET_USERS = "Success fetch users";
